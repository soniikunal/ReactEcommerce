        ...
        <Col className='d-flex align-items-center auth-bg px-2 p-lg-5' lg='4' sm='12'>
          <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
            ...
            <Form action='/' className='auth-register-form mt-2' onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className='mb-1'>
                <Label className='form-label' for='register-contactNumber'>
                  Contact Number
                </Label>
                <Controller
                  id='contactNumber'
                  ...
                  control={control}
                  render={({ field }) => (
                    <Input autoFocus placeholder='7162726606' invalid={errors.contactNumber && true} {...field} />
                  )}
                />
                {errors.contactNumber ? <FormFeedback>{errors.contactNumber.message}</FormFeedback> : null}
              </div>
              <div className='mb-1'>
